...
<div class="bg-gray-100">
    ...
    <div class="container w-full mx-auto">
        <div class="w-full px-4 md:px-0 md:mt-8 mb-16 text-gray-800 leading-normal">
            ...
            <v-container>
                <h2 class="font-bold text-3xl"><i class="em em-water_buffalo text-4xl" aria-role="presentation" aria-label=""></i> &nbsp; เพิ่มอายุควาย</h2>
                <!-- <h2 class="font-bold text-2xl">เพิ่มอายุ</h2> -->
                ...
                <div class="w-full md:w-1/1 xl:w-1/1 p-3">
                    ...
                    <div class="bg-white border-b-4 border-blue-500  rounded shadow-xl p-10">
                        ...
                        <!-- <v-card-title primary-title> -->
                            <!-- <v-spacer></v-spacer> -->
                            <v-btn depressed tile block medium class="mt-2" @click="$router.push('/user/buffalo')" color="success">บันทึก</v-btn>
                        <!-- </v-card-title> -->
                    </div>
                    <!--/Metric Card-->
                </div>
